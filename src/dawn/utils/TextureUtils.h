...
// we need to include the header from a different directory 
// so that we can exclude it when we compile with emscripten
// emscripten uses its own webgpu headers
