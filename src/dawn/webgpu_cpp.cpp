...
namespace wgpu {
    ...
    static_assert(offsetof(DeviceProperties, chromiumExperimentalDp4a) == offsetof(WGPUDeviceProperties, chromiumExperimentalDp4a),
            "offsetof mismatch for DeviceProperties::chromiumExperimentalDp4a");
    static_assert(offsetof(DeviceProperties, indirectFirstInstance) == offsetof(WGPUDeviceProperties, indirectFirstInstance),
            "offsetof mismatch for DeviceProperties::indirectFirstInstance");
    ...
    void Device::SetLoggingCallback(LoggingCallback callback, void * userdata) const {
        wgpuDeviceSetLoggingCallback(Get(), callback, reinterpret_cast<void * >(userdata));
    }
